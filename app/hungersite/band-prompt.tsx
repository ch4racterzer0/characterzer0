  ...
  return (
    <>
      <button
        type="button"
        onClick={openFresh}
        className="w-full flex items-center justify-between border border-blue-400/20 bg-blue-950/5 hover:bg-blue-950/15 hover:border-blue-400/35 transition-colors px-3 py-2 text-[10px] sm:text-xs cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400/40"
      >
        <span className="text-blue-300/55 tracking-[0.2em] uppercase">
      ...
      {open &&
        ...
        createPortal(
          ...
          >
            ...
            />
            <div
              className="relative w-full max-w-lg border border-blue-400/45 bg-black px-6 py-8 sm:px-10 sm:py-10"
              style={{
                boxShadow:
            ...
            >
              <button
                ...
                onClick={() => setOpen(false)}
                aria-label="close"
                className="absolute top-2 right-2 sm:top-3 sm:right-3 w-8 h-8 rounded-full border border-blue-400/40 text-blue-100 text-base leading-none flex items-center justify-center hover:bg-blue-900/40 hover:border-blue-300/60 transition-colors"
              >
                ×
              </button>
              ...
              {phase === "asking" ? (
                <form onSubmit={submit} className="space-y-5 text-center">
                  ...
                  <p
                    className="text-blue-100 text-base sm:text-lg tracking-wider"
                  ...
                  <input
                    ...
                    className="w-full bg-blue-950/30 border border-blue-400/40 text-blue-100 text-center text-base sm:text-lg tracking-wider rounded px-5 py-3 outline-none focus:border-blue-300/70 focus:bg-blue-950/50 transition-colors placeholder:text-blue-100/30"
                  />
                  <button
                    type="submit"
                    disabled={!input.trim()}
                    className="text-blue-100 text-xs sm:text-sm tracking-[0.4em] uppercase border border-blue-400/50 rounded px-6 py-2 hover:bg-blue-900/40 hover:border-blue-300/70 transition-colors disabled:opacity-40"
                  >
                    submit
                  </button>
                </form>
