      ...
      <div className="flex flex-wrap items-end gap-3 sm:gap-6 font-mono tabular-nums">
        {[
          ...
          <div key={u as string} className="flex flex-col items-center">
            <span
              className="text-blue-100 text-3xl sm:text-5xl tracking-wider"
              style={{
                textShadow:
                  "0 0 12px rgba(96,165,250,0.7), 0 0 28px rgba(59,130,246,0.4)",
              }}
            >
              {pad(v as number)}
            </span>
            <span className="text-blue-300/50 text-[9px] sm:text-[10px] tracking-[0.3em] uppercase mt-1">
              {u as string}
            </span>
          </div>
        ))}
