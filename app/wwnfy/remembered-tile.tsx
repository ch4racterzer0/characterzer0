                ...
                {view === "characterzer0" && (
                  <>
                    ...
                    <div className="space-y-4 text-sm leading-relaxed" style={{ color: TEXT }}>
                      <p>
                        Every missing child belongs on this wall — trafficked,
                        abducted, runaway, cold case, never recovered. Not just
                        American. Anyone, anywhere.
                      </p>
                      <p>
                  ...
                  <>
                    ...
                    <div className="space-y-4 text-sm leading-relaxed" style={{ color: TEXT }}>
                      <p>
                        ...
                        all, if you have a missing child you want on this
                        wall — this is the door.
                      </p>
                      <p>
                    ...
                    <div className="mt-6 space-y-3">
                      ...
                      <a
                        href="mailto:mfowlkes@gmail.com?subject=WWNFY%20%E2%80%94%20a%20child%20to%20add"
                        className="block w-full text-center font-mono uppercase tracking-[0.25em] text-xs font-bold px-4 py-3 rounded-sm transition-transform hover:-translate-y-0.5"
                        style={{
                          color: TEXT,
