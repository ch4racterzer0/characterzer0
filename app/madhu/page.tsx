      ...
      <article className="max-w-3xl mx-auto flex flex-col gap-10 font-light leading-relaxed">
        ...
        <section className="space-y-4 text-base sm:text-lg">
          ...
          <p>
            ...
            earned. nothing is sold. the door to hungersite opens with one
            parked domain pointed at this hub. that&rsquo;s the entry to L1,
            not here.
          </p>
        </section>
        ...
        <section className="space-y-5">
          ...
          <ol className="space-y-4">
            ...
            <li className="flex items-start gap-4">
              ...
              <div>
                <p className="text-blue-100 font-medium">hungersite</p>
                <p className="text-blue-100/60 text-sm sm:text-base italic">
            ...
            <li className="flex items-start gap-4">
              ...
              <div>
                <p className="text-blue-100 font-medium">dripfield</p>
                <p className="text-blue-100/60 text-sm sm:text-base italic">
