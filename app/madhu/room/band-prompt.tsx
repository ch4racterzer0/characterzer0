  ...
  return (
    <>
      <button
        type="button"
        onClick={openFresh}
        className="w-full flex items-center justify-between border border-red-400/20 bg-red-950/5 hover:bg-red-950/15 hover:border-red-400/35 transition-colors px-3 py-2 text-[10px] sm:text-xs cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400/40"
      >
        <span className="text-red-300/55 tracking-[0.2em] uppercase">
      ...
      {open &&
        ...
        createPortal(
          ...
          >
            ...
            />
            <div
              className="relative w-full max-w-lg border border-red-400/45 bg-black px-6 py-8 sm:px-10 sm:py-10"
              style={{
                boxShadow:
            ...
            >
              <button
                ...
                onClick={() => setOpen(false)}
                aria-label="close"
                className="absolute top-2 right-2 sm:top-3 sm:right-3 w-8 h-8 rounded-full border border-red-400/40 text-red-100 text-base leading-none flex items-center justify-center hover:bg-red-900/40 hover:border-red-300/60 transition-colors"
              >
                ×
              </button>
              ...
              {phase === "asking" ? (
                <form onSubmit={submit} className="space-y-5 text-center">
                  ...
                  <p
                    className="text-red-100 text-base sm:text-lg tracking-wider"
                  ...
                  <input
                    ...
                    className="w-full bg-red-950/30 border border-red-400/40 text-red-100 text-center text-base sm:text-lg tracking-wider rounded px-5 py-3 outline-none focus:border-red-300/70 focus:bg-red-950/50 transition-colors placeholder:text-red-100/30"
                  />
                  <button
                    type="submit"
                    disabled={!input.trim()}
                    className="text-red-100 text-xs sm:text-sm tracking-[0.4em] uppercase border border-red-400/50 rounded px-6 py-2 hover:bg-red-900/40 hover:border-red-300/70 transition-colors disabled:opacity-40"
                  >
                    submit
                  </button>
                </form>
                ...
                <div className="space-y-5">
                  ...
                  <div
                    ...
                    style={{ textShadow: "0 0 6px rgba(248,113,113,0.35)" }}
                  >
                    <p className="text-red-300/55 text-[10px] tracking-[0.3em] uppercase">
                      // from character zer0
                    </p>
                  ...
                  <div
                    className="border-l-2 border-red-400/50 pl-4 py-1 space-y-2 text-sm sm:text-base"
                  >
                    <p className="text-red-300/55 text-[10px] tracking-[0.3em] uppercase">
                      // tip from me (eliza)
                    </p>
                    <p className="text-red-200/90 leading-relaxed">
                      ...
                      <span className="text-red-100">2 or 3 source links</span>
                  ...
                  <hr className="border-red-100/15" />

                  <p className="text-red-300/70 text-sm sm:text-base leading-relaxed">
                  ...
                  <p className="text-red-300/45 italic text-[10px] sm:text-xs tracking-[0.2em] uppercase pt-1 text-center">
