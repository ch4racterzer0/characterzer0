  ...
  return (
    <div ref={wrapperRef} className="relative inline-flex flex-col items-stretch w-[6.5rem] sm:w-28">
      {pickerOpen && (
        ...
        >
          {/* open letter to the musicians whose tracks play here */}
          <div
            className="rounded-md px-4 py-4"
            style={{
              background:
                "linear-gradient(180deg, rgba(28,26,24,0.96) 0%, rgba(14,14,16,0.96) 100%)",
              border: "1px solid rgba(225,180,90,0.45)",
              boxShadow:
                "inset 0 1px 0 rgba(220,220,225,0.10), 0 0 18px rgba(225,180,90,0.12), 0 6px 14px -4px rgba(0,0,0,0.85)",
            }}
          >
            <p
              className="font-mono uppercase tracking-[0.3em] text-[8px] mb-3 text-center"
              style={{
            ...
            <div
              className="space-y-3 italic leading-relaxed"
              style={{
            ...
            >
              <p>hi,</p>
              <p>
                i wish i could donate to you, i honestly do, but i simply
                can&rsquo;t... but i am using your music to launch a concept,
                and at the very least i wanted you to know.
              </p>
              <p>
                I wanted you to know I wasn&rsquo;t just using your music
                because I like it and think people will like it... that is
                how every other person uses your music... and rightly so... i
                am using it to pay a debt.
              </p>
              <p>
                one i do not owe, and i won&rsquo;t pretend to know if you
                do... But that could change in a flash... but i have not paid
                because it has not impacted me.
              </p>
              <p>
                I am using your music to help me pay my receipt.. and this is
                now your receipt...
              </p>
              <p>
                thank you, from someone you will never meet, who hopes your
                music changes the fucking world i live in
              </p>
              <p>
                your music is the soundtrack to their memorial. i thought you
                should know that
              </p>
              <p>thank you</p>
              <p
                className="not-italic pt-1"
                style={{
