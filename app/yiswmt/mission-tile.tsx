  ...
  return (
    <>
      <button
        ...
        className="relative inline-flex flex-col items-stretch w-[8rem] sm:w-40 rounded-md overflow-hidden transition-transform hover:-translate-y-0.5 cursor-pointer focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-300/40"
        style={{
          background: BODY,
          border: `1px solid ${BORDER}`,
          boxShadow:
            "inset 0 1.5px 0 rgba(255,255,255,0.18), inset 0 -2px 0 rgba(0,0,0,0.45), inset 0 0 0 1px rgba(0,0,0,0.22), 0 6px 12px -5px rgba(0,0,0,0.75)",
        }}
      >
        <span
          aria-hidden
        ...
        >
          <span
            aria-hidden
            className="absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 w-3.5 h-1 rounded-sm"
            style={{
              background:
        ...
        <span
          className="relative block px-2 pb-2 text-center font-mono uppercase"
          style={{
            color: SUB,
