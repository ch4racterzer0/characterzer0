                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                      ...
                      >
                        ...
                        <p
                          ...
                          style={{ color: SUB }}
                        >
                          talk to me. ask. suggest. submit a soldier.
                        </p>
                      </button>
                    </div>
                ...
                {view === "characterzer0" && (
                  <>
                    ...
                    <div className="space-y-4 text-sm leading-relaxed" style={{ color: TEXT }}>
                      <p>
                        I built this for the people we don&rsquo;t hold long
                        enough. Service members, from anywhere — not just
                        American. Anyone who put their life between us and
                        something worse.
                      </p>
                      <p>
                  ...
                  <>
                    ...
                    <div className="space-y-4 text-sm leading-relaxed" style={{ color: TEXT }}>
                      <p>
                        ...
                        all, if you have a soldier you want honored — this is
                        the door.
                      </p>
                      <p>
                    ...
                    <div className="mt-6 space-y-3">
                      ...
                      <a
                        href="mailto:mfowlkes@gmail.com?subject=YISWMT%20%E2%80%94%20a%20soldier%20to%20honor"
                        className="block w-full text-center font-mono uppercase tracking-[0.25em] text-xs font-bold px-4 py-3 rounded-sm transition-transform hover:-translate-y-0.5"
                        style={{
                          color: TEXT,
