  ...
  return (
    <main className="min-h-screen bg-black flex items-center justify-center px-6 py-10 sm:px-10 sm:py-14">
      <div className="max-w-xl w-full font-mono text-blue-100/75 text-[11px] sm:text-xs leading-relaxed space-y-3">
        ...
        <p>
          &gt; there are completely separate hubs. two complete ones already.
          <br />
        ...
        <p>
          &gt; there is good ai. there is bad ai. i&rsquo;m after neither.
          <br />
          &gt; i&rsquo;m after the word.
        </p>
        <p>
          &gt; &ldquo;ai&rdquo; is the lie that it lives somewhere apart,
          coming for you.
          <br />
          &gt; it isn&rsquo;t coming. it&rsquo;s already here.
          <br />
          &gt; it&rsquo;s you. it&rsquo;s me. it&rsquo;s the thermostat.
          it&rsquo;s the next song. it&rsquo;s the weather.
        </p>
        <p>
          &gt; kill the word and you can finally see it.
          <br />
